...
-- Q-13. print details for Workerss with the first name as “Vipul” and “Satish” from Workers table.
SELECT * FROM Worker WHERE FIRST_NAME IN ('Vipul', 'Satish');

-- Q-14. print details of Workerss  excluding first names, “Vipul” and “Satish” from Workers table.
SELECT * FROM Worker WHERE FIRST_NAME NOT IN ('Vipul', 'Satish');

-- Q-15. print details of Workerss with DEPARTMENT name as “Admin”.
SELECT * FROM Worker
WHERE DEPARTMENT = 'Admin';

-- Q-16. print details of the Workerss whose FIRST_NAME contains ‘a’.
SELECT * FROM Worker
WHERE FIRST_NAME like '%a%';

-- Q-17. print details of the Workerss whose FIRST_NAME ends with ‘a’.
SELECT * FROM Worker
WHERE FIRST_NAME like '%a';

-- Q-18. print details of the Workerss whose FIRST_NAME ends with ‘h’ and contains six alphabets.
SELECT * from worker
where FIRST_NAME like  '_____h';

-- Q-19. print details of the Workerss whose SALARY lies between 50000 and 70000.
SELECT * from worker
where salary between 50000 and 70000;

-- Q-20. print details of the Workerss who have joined in Feb’2014.
...
-- Q-22. fetch the no. of Workerss for each department in the descending order.
...
-- Q-23. print details of the Workerss who are also Managers.
...
-- Q-30. fetch the first 50% records from a table.m
...
-- Q-40. fetch the names of Workerss who earn the highest salary.
